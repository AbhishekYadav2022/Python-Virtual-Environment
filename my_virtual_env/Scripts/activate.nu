...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\abhishek\Desktop\My Codes\Python Tutorial CWH\Python Virtual Environment\my_virtual_env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\abhishek\Desktop\My Codes\Python Tutorial CWH\Python Virtual Environment\my_virtual_env\Scripts\deactivate.nu'
